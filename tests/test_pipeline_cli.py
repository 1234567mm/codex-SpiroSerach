...
class PipelineCliTests(unittest.TestCase):
    def test_seed_candidates_can_be_loaded_and_traced_to_evidence(self):
        ...
        if report["local_paper_trace"]["fallback_used"]:
            ...
            self.assertEqual(report["local_paper_trace"]["path"], "pdf/extracted_text.txt")
            self.assertEqual(report["local_paper_trace"]["trust_level"], "L3_anchor_verified")
