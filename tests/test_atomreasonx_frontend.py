...
class TestTauriReadonlySidecarBridge(unittest.TestCase):
    ...
    def test_runtime_workbench_adapter_maps_readonly_run_without_command_surface(self) -> None:
        ...
        self.assertIn("visibleWorkspace && !runtimeReadAdapter.readOnly", main_tsx)
        self.assertIn("const workflowTaskExecutor = visibleWorkspace && !runtimeReadAdapter.readOnly ?", main_tsx)
