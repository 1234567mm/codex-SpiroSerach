// Settings navigation sidebar, ported from the Reasonix desktop
// (https://github.com/esengine/DeepSeek-Reasonix, MIT). The tab list is trimmed
// to the tabs AtomReasonX ships: bots, remote, diagnostics and shortcuts are
// excluded because the project has no backend for them.
...
function settingsTabIcon(id: SettingsTab): ReactNode {
  ...
  switch (id) {
    ...
    case "data-sources": return <Database {...props} />;
